...
```
/design:design-system audit                    # Full system audit
/design:design-system document [component]     # Document a component
/design:design-system extend [pattern]         # Design a new component or pattern
```
