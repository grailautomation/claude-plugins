...
```
/engineering:incident $ARGUMENTS
```

## Modes

```
/engineering:incident new [description]     # Start a new incident
/engineering:incident update [status]       # Post a status update
/engineering:incident postmortem            # Generate postmortem from incident data
```
