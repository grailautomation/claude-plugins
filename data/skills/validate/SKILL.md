...
```
/data:validate <analysis to review>
```
...
```
/data:validate Review this quarterly revenue analysis before I send it to the exec team: [analysis]
```

```
/data:validate Check my churn analysis -- I'm comparing Q4 churn rates to Q3 but Q4 has a shorter measurement window
```

```
/data:validate Here's a SQL query and its results for our conversion funnel. Does the logic look right? [query + results]
```

## Tips

- Run /data:validate before any high-stakes presentation or decision
