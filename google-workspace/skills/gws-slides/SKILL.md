...
name: gws-slides
description: >-
  Google Slides: Create and manage presentations via the gws CLI. Use when the user
  asks to "create presentation", "edit slides", "update slide deck", or any Google
  Slides operation.
---
