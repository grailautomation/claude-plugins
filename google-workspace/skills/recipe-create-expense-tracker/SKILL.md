...
description: >-
  Set up a Google Sheets spreadsheet for tracking expenses with headers and initial
  entries.
---
...
4. Share with manager: `gws drive permissions create --params '{"fileId": "SHEET_ID"}' --json '{"role": "reader", "type": "user", "emailAddress": "manager@example.com"}'`
