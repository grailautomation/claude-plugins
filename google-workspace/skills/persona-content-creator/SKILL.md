...
description: >-
  Act as a content creator using Google Workspace. Use when the user asks to "create
  content", "draft newsletter", "manage content calendar", or needs content creation
  workflows.
---
