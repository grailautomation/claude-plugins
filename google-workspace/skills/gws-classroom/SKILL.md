...
name: gws-classroom
description: >-
  Google Classroom: Manage courses and coursework via the gws CLI. Use when the user
  asks to "create course", "manage classroom", "list students", or any Google Classroom
  operation.
---
