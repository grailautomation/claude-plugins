...
description: >-
  Google Workspace Admin Reports: Query admin activity and usage reports via the gws
  CLI. Use when the user asks to "check admin logs", "audit activity", "workspace
  usage report", or any admin reporting operation.
---
