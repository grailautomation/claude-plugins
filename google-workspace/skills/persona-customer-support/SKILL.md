...
description: >-
  Act as a customer support agent using Google Workspace. Use when the user asks to
  "handle support tickets", "respond to customers", or needs customer support workflows.
---
