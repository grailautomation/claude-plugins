...
name: gws-calendar
description: >-
  Google Calendar: Manage calendars and events via the gws CLI. Use when the user
  asks to "check calendar", "schedule meeting", "create event", "show agenda", "find
  free time", or any calendar operation.
---
