...
description: >-
  Act as an IT administrator using Google Workspace. Use when the user asks to "manage
  workspace users", "check admin reports", "audit activity", or needs IT administration
  workflows.
---
