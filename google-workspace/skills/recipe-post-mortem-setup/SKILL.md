...
description: >-
  Create a Google Docs post-mortem, schedule a Google Calendar review, and notify
  via Chat.
---
...
2. Schedule review meeting: `gws calendar +insert --summary 'Post-Mortem Review: [Incident]' --attendee team@example.com --start '2026-03-16T14:00:00' --end '2026-03-16T15:00:00'`
