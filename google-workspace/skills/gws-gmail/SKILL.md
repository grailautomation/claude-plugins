...
name: gws-gmail
description: >-
  Gmail: Send, read, and manage email via the gws CLI. Use when the user asks to "send
  email", "check inbox", "read gmail", "triage email", "reply to email", "forward
  email", or any Gmail operation.
---
