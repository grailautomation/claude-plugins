...
name: gws-sheets
description: >-
  Google Sheets: Read, write, and manage spreadsheets via the gws CLI. Use when the
  user asks to "read spreadsheet", "update sheet", "append rows", "create spreadsheet",
  or any Google Sheets operation.
---
