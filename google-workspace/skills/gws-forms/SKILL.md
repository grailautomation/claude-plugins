...
name: gws-forms
description: >-
  Google Forms: Manage forms and responses via the gws CLI. Use when the user asks
  to "create form", "read responses", "manage google form", or any Google Forms operation.
---
