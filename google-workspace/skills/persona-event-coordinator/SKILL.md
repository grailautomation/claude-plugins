...
description: >-
  Act as an event coordinator using Google Workspace. Use when the user asks to "plan
  event", "coordinate logistics", "manage event schedule", or needs event planning
  workflows.
---
