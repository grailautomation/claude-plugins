...
description: >-
  Act as an HR coordinator using Google Workspace. Use when the user asks to "manage
  onboarding", "track PTO", "handle HR tasks", or needs HR coordination workflows.
---
