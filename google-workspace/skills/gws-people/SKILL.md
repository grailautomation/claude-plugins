...
name: gws-people
description: >-
  Google People/Contacts: Manage contacts via the gws CLI. Use when the user asks
  to "find contact", "list contacts", "search people", or any Google Contacts operation.
---
