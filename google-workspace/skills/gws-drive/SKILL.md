...
name: gws-drive
description: >-
  Google Drive: Manage files, folders, and shared drives via the gws CLI. Use when
  the user asks to "upload file", "share file", "list drive files", "search drive",
  "download from drive", or any Google Drive operation.
---
