...
name: gws-modelarmor
description: >-
  Google Model Armor: Content safety screening for AI-generated content via the gws
  CLI. Use when the user asks to "sanitize content", "screen for safety", "create
  safety template", or any Model Armor operation.
---
