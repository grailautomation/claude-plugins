...
name: gws-docs
description: >-
  Google Docs: Create, read, and edit documents via the gws CLI. Use when the user
  asks to "read doc", "create document", "edit google doc", or any Google Docs operation.
---
