...
description: >-
  Act as an executive assistant using Google Workspace. Use when the user asks to
  "manage my schedule", "triage my inbox", "act as exec assistant", or needs executive
  support workflows.
---
