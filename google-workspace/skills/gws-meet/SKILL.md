...
name: gws-meet
description: >-
  Google Meet: Manage meeting spaces and recordings via the gws CLI. Use when the
  user asks to "create meeting", "list recordings", "manage meet space", or any Google
  Meet operation.
---
